...
{
    public partial class CriaRelacoesPessoas : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_condutor", x => x.pessoaId);
                    table.ForeignKey(
                        name: "FK_condutor_pessoa_pessoaId",
                        column: x => x.pessoaId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_transportadora", x => x.pessoaId);
                    table.ForeignKey(
